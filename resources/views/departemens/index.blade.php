...
<div class="container wow fadeInUp" data-wow-duration="0.5s">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4" style="padding-top: 20px;">
        ...
        <div class="section-heading wow bounceIn" data-wow-duration="1s" data-wow-delay="0.2s" style="margin-bottom: 0;">
            <h2 style="margin: 0;">Daftar <em style="color: #fe3f40; font-style: normal;">Departemen</em></h2>
        </div>

        <a href="{{ route('departemens.create') }}" class="btn-add-custom">
    ...
    <div class="table-responsive">
        ...
        <table class="table table-striped table-hover mb-0" style="width: 100%; white-space: nowrap;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center" style="vertical-align: middle;">
                        <div style="display: flex; justify-content: center; align-items: center; gap: 5px;">
                            ...
                            <a href="{{ route('departemens.show', $departemen) }}" class="btn-action btn-action-detail" title="Detail">
                                <i class="fa fa-eye"></i>
                            </a>

                            <a href="{{ route('departemens.edit', $departemen) }}" class="btn-action btn-action-edit" title="Edit">
                                <i class="fa fa-pencil"></i>
                            </a>

                            <form action="{{ route('departemens.destroy', $departemen) }}" method="POST" style="display:inline; margin:0; padding:0;">
                                @csrf
                                @method('DELETE')
                ...
                @empty
                <tr>
                    <td colspan="2" class="text-center py-4 text-muted">Belum ada data departemen.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
