                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <form action="{{ route('announcements.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" name="content" id="content" class="form-control" rows="5" required>{{ old('content') }}</textarea>
                        </div>

                        <div class="mb-3">
                            <label for="date_posted" class="form-label">Tanggal Posting</label>
                            <input type="date" name="date_posted" id="date_posted" class="form-control" value="{{ old('date_posted', date('Y-m-d')) }}" required>
                        </div>
