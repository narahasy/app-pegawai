...
<div class="container wow fadeInUp" data-wow-duration="0.5s">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4" style="padding-top: 20px;">
        ...
        <div class="section-heading wow bounceIn" data-wow-duration="1s" data-wow-delay="0.2s" style="margin-bottom: 0;">
            <h2 style="margin: 0;">Daftar <em style="color: #fe3f40; font-style: normal;">Gaji</em></h2>
        </div>

        <a href="{{ route('salaries.create') }}" class="btn-add-custom">
        ...
        <table class="table table-striped table-hover mb-0" style="width: 100%; white-space: nowrap;">
            ...
            <thead style="background-color: #333; color: white;">
                <tr>
                    ...
                    <th style="min-width: 120px;">Bulan</th>
                    <th style="min-width: 150px;">Gaji Pokok</th>
                    <th style="min-width: 150px;">Tunjangan</th>
                    <th style="min-width: 150px;">Potongan</th>
            ...
            <tbody>
                ...
                <tr>
                    <td style="vertical-align: middle; font-weight: bold;">
                        {{ $salary->employees->nama_lengkap ?? 'N/A' }}
                    </td>
                    ...
                    <td class="text-center" style="vertical-align: middle;">
                        <div style="display: flex; justify-content: center; align-items: center; gap: 5px;">
                            ...
                            <a href="{{ route('salaries.show', $salary) }}" class="btn-action btn-action-detail" title="Detail">
                                <i class="fa fa-eye"></i>
                            </a>

                            <a href="{{ route('salaries.edit', $salary) }}" class="btn-action btn-action-edit" title="Edit">
                                <i class="fa fa-pencil"></i>
                            </a>

                            <form action="{{ route('salaries.destroy', $salary) }}" method="POST" style="display:inline; margin:0; padding:0;">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn-action btn-action-delete" onclick="return confirm('Yakin ingin menghapus data gaji ini?')" title="Hapus">
                ...
                @empty
                <tr>
                    <td colspan="7" class="text-center py-4 text-muted">Belum ada data gaji.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
